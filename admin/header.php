...
<head>
	...
	<meta name="description" content="Discover Akademi - School and Education Management System. Specially designed for professionals, and for business. Akademi provides advanced features and an easy-to-use interface for creating a top-quality website with School and Education Dashboard" >
	<meta property="og:title" content="Akademi : School and Education Management System" >
	<meta property="og:description" content="Akademi - School and Education Management System. Specially designed for professionals, and for business. Akademi provides advanced features and an easy-to-use interface for creating a top-quality website with School and Education Dashboard">
...
<body>
    ...
    ********************-->
    <!--**********************************
        Main wrapper start
    ***********************************-->
    <div id="main-wrapper" class="wallet-open active show menu-toggle">
						...
						<li class="nav-item dropdown notification_dropdown all">
							...
							<svg width="20" height="20" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="dropdown-menu dropdown-menu-end of-visible">
                                    ...
                                    <div id="DZ_W_Notification1" class="widget-media dlab-scroll p-3" style="height:180px;">
										<ul class="timeline">
											<li>
			...
			<div class="dlabnav-scroll">	
				<ul class="metismenu" id="menu">
					...
					<ul aria-expanded="false">
						...
						<li><a href="fees-head">Fees Head</a></li>
					...
					<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
						...
						<ul aria-expanded="false">
							...
							<li><a href="food-details">Food Detail</a></li>
