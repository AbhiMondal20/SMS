                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive basic-tbl">
                                <table id="example-1" class="display" style="min-width: 845px">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><span class="text-primary font-w600">2023-2026</span></td>
                                            <td><span class="text-primary font-w600">GNM</span></td>
                                            <td><span class="text-primary font-w600">GNM 2023-2026</span></td>
                                            <td><span class="text-primary font-w600">12</span></td>
                                            <td><span class="text-primary font-w600">₹ 1001000.00</span></td>
                                            <td><span class="text-primary font-w600">0</span></td>
                                            <td><span class="text-primary font-w600">₹ 0</span></td>
                                        </tr>
                                    </tbody>
                                </table>
