...
<head>
	...
	<meta name="description"
		content="Discover Akademi - School and Education Management System. Specially designed for professionals, and for business. Akademi provides advanced features and an easy-to-use interface for creating a top-quality website with School and Education Dashboard">
	<meta property="og:title" content="Akademi : School and Education Management System">
	<meta property="og:description"
		content="Akademi - School and Education Management System. Specially designed for professionals, and for business. Akademi provides advanced features and an easy-to-use interface for creating a top-quality website with School and Education Dashboard">
								...
								<div class="dropdown header-profile2">
									<a class="nav-link ms-0" href="javascript:void(0);" role="button"
										...
										<div class="header-info2 d-flex align-items-center">
											...
											<img class="rounded-circle" width="35" src="images/user1.png"
												alt="Male Student">
										</div>
									</a>
				...
				<ul class="metismenu" id="menu">
					<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
						...
						<ul aria-expanded="false">
							<li><a href="fees-payment">Dashboard</a></li>
						</ul>
					</li>
					<li>
